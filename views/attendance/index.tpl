...
<div class="container">
    ...
    {{template "alert.tpl" .}}
        ...
        <div class="panel {{mod $i 2 "panel-success" "panel-info"}} ">
            <div class="panel-heading">打卡方案{{$i}}-{{$act.Name}} </div>
            <div class="panel-body container">
                <div class="row">
                    <div class="col-lg-6 col-sm-10">
                        <p>花{{$act.JoinPrice}}积分参与本活动，作为押金积分</p>
                        <p>参与活动后，坚持每天早晨6-9点打卡</p>
                        <p>如果有1天中断，押金积分的{{$act.LoserWastagePercent}}%将进入“公共奖金池”</p>
                        <p>连续坚持{{$act.BonusNeedStep}}天以上，将可以参与瓜分“公共奖金池”</p>
                        <p>中断后，可以补交后，次日继续打卡参与活动，重新计算累计，历史累计清零</p>
                        <p>中断后，如果没补交，每多中断一天，剩余押金将继续按{{$act.LoserWastagePercent}}%比例扣除进入“公共奖金池”</p>
                        <p>押金扣到0为止</p>
                        <p>活动最终解释权归我公司所有</p>
                    </div>
                    <div class="col-lg-6 col-sm-10">
                        <div class="well well-sm">
                            <p>参与人数：<span class="label label-warning">{{$act.JoinedUserCount}} 人</span></p>
                            <p>公共奖池：<span class="label label-danger">{{$act.JoinedGoldsCount}} 积分</span></p>
                            <p>参与价格：<span class="label label-info">{{$act.JoinPrice}} 积分</span></p>
                            <p>预计分红：<span class="label label-success">3.4 积分/日</span></p>
                            <p>
